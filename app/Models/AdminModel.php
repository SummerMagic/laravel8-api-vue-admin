...
class AdminModel extends BaseModel
{
    ...
    {
        return $admin['password'] === md5(md5($password));
    }
     ...
     * @return mixed
     */
    public function setCacheToken(int $id , string $token)
    {
        $cacheKey = $this->adminTokenRedisKey . $token;
        $second = 7200;
        return Cache::remember($cacheKey, $second, function () {
